...
public class User {
	...
	//the length of user's profile. It is used to compute cosine similarity 
	...
	public static double consionSimilarity(HashMap<Integer, Double> uprofile,
			HashMap<Integer, Double> vprofile, double ulength, double vlength) {
	...
	public static double consionSimilarity(HashMap<Integer, Double> uprofile,
			HashMap<Integer, Double> vprofile) {
		Iterator<Integer> uitr = uprofile.keySet().iterator();
		double numerator = 0;
		double ulength = 0;
		while (uitr.hasNext()) {
